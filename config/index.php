...
$query .= "CREATE TABLE IF NOT EXISTS ITEMS (ITEMID INT NOT NULL, NAME VARCHAR(26) NOT NULL, PRICE INT NOT NULL, DESCP VARCHAR(100) NOT NULL, OWNER VARCHAR(26) NOT NULL, ENTRY_TIME DATETIME, PRIMARY KEY (ITEMID), FOREIGN KEY (OWNER) REFERENCES USER(USERNAME));";
...
if (mysqli_query($db, $query)) 
    die("Error creating table ". mysqli_error());
?>